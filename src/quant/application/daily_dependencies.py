    ...
    nodes = [
        ...
        DependencyNode(
            ...
            contract_sources=(
                ...
                "src/quant/strategies/custom/b1_family.py",
        ...
        DependencyNode(
            ...
            outputs=("data/features/b1/training_xgb_project_vars.parquet",
            ...
            notes="Compute once for the B1/Z active-candidate union; preserve the B1 gate cache semantics.",
        ),
        DependencyNode(
        ...
        DependencyNode(
            ...
            Lifecycle.PRODUCTION, Cadence.TRADE_DAILY, (_edge("score.b1"),),
            _exact(_json("web/data/b1_daily_plan.json", "signal_date")),
